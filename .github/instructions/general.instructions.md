# clinerules
## 前提条件
### 1. 特に指示がなくても、以下のmdがあれば実装前に参照すること
...
- ユーザーが説明を求めない限り、ユーザー向けの内容を３行以内。
- 文を体言止めにして、量を極力少なくして
- サブタスク内の作業量をモニターし、100kトークン到達したとき、作業継続するための別のタスクを生成して。
  それまでの作業、今後の作業内容といった永続化に必要な全ての情報を次のタスクへ連携する。
